...
let is_num_pressed () =
  is_key_pressed Two || is_key_pressed Three || is_key_pressed Four
  || is_key_pressed Five || is_key_pressed Six || is_key_pressed Seven
  || is_key_pressed Eight || is_key_pressed Nine
